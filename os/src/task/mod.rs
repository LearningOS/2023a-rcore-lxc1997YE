...
/// Counts the number of occurrences of a system call in the current process.
...
/// get run time of a system call in the current process.
pub fn get_current_run_time() -> usize {
    TASK_MANAGER.get_current_run_time()
}

/// get run status of a system call in the current process.
